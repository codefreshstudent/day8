address=[
 ...
 ['叶*⽣', '江苏省扬州市扬⼦江中路756号'],
 ['赵*兴', '北京市海淀区⻄⼆旗上地信息路1号⾦远⻅⼤楼华纬讯301'],['徐*⾰', '北京市海淀区闵庄路3号102栋⼆层206'],
 ['徐*', '安徽省淮南市⾦荷⼩区(⾦格商场旁)'],
 ...
 ['关*轩', '⼭⻄省⻓治市⽯哲镇'],
 ['罗*', '河北省廊坊市书⾹苑⼩区四号楼'],['段**', '北京市朝阳区酒仙桥东路M5世纪互联'],
 ['杜*伟', '北京市昌平区汇德商厦⽼男孩教育'],
 ['王*', '北京市昌平区汇德商厦四楼'],
 ...
 ['陈*⼭', '安徽省六安市南港镇'], ['赵*', '⿊⻰江省哈尔滨市锦⼭路5号，⿊⻰江省地质科学研究所'],
 ['伍*', '安徽省芜湖市泉塘镇'],
 ...
 ['杨*平', '北京市昌平区沙河镇于⾟庄村赋腾公寓'],['⻩*', '浙江省杭州市衢江路耀江福村3单元602'],
...
#
#     return city1
# print(catch_adress(a,'陕⻄',city1))
#获取地址
def catch_adress1(a,b):
    city1=[]
    for i in range(len(a)):
         if a[i][0][0:2]==b:
            city1.append(a[i])
...
A['上海市']=catch_adress1(a,'上海')
A['北京市']=catch_adress1(a,'北京')
A['河南省']=catch_adress1(a,'河南')
A['山西省']=catch_adress1(a,'⼭⻄')
A['湖北省']=catch_adress1(a,'湖北')
A['天津市']=catch_adress1(a,'天津')
A['安徽省']=catch_adress1(a,'安徽')
A['新疆省']=catch_adress1(a,'新疆')
A['浙江省']=catch_adress1(a,'浙江')
A['吉林省']=catch_adress1(a,'吉林')
A['陕西省']=catch_adress1(a,'陕⻄')
A['辽宁省']=catch_adress1(a,'辽宁')
A['河北省']=catch_adress1(a,'河北')
A['内蒙古']=catch_adress1(a,'内蒙')
A['宁夏省']=catch_adress1(a,'宁夏')
A['山东省']=catch_adress1(a,'⼭东')
A['江苏省']=catch_adress1(a,'江苏')
A['黑龙江省']=catch_adress1(a,'⿊⻰')
A['⽢肃省']=catch_adress1(a,'⽢肃')
A['江苏省']=catch_adress1(a,'江苏')
A['海南省']=catch_adress1(a,'海南')
print(A)
